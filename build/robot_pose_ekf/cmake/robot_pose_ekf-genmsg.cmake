...
get_filename_component(_filename "/home/er/myagv_ros/src/robot_pose_ekf/srv/GetStatus.srv" NAME_WE)
add_custom_target(_robot_pose_ekf_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_pose_ekf" "/home/er/myagv_ros/src/robot_pose_ekf/srv/GetStatus.srv" ""
)
...
_generate_srv_cpp(robot_pose_ekf
  "/home/er/myagv_ros/src/robot_pose_ekf/srv/GetStatus.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot_pose_ekf)
  install(CODE "execute_process(COMMAND \"/home/er/.pyenv/shims/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot_pose_ekf\")")
  # install generated code
  install(

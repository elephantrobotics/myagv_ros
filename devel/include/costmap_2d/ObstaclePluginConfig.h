...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ObstaclePluginConfig::AbstractParamDescriptionConstPtr(new ObstaclePluginConfig::ParamDescription<int>("combination_method", "int", 0, "Method for combining two layers", "{'enum': [{'name': 'Overwrite', 'type': 'int', 'value': 0, 'srcline': 11, 'srcfile': '/home/er/myagv_ros/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg', 'description': 'Overwrite values', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Maximum', 'type': 'int', 'value': 1, 'srcline': 12, 'srcfile': '/home/er/myagv_ros/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg', 'description': 'Take the maximum of the values', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Nothing', 'type': 'int', 'value': 99, 'srcline': 13, 'srcfile': '/home/er/myagv_ros/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg', 'description': 'Do nothing', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Method for combining layers enum'}", &ObstaclePluginConfig::combination_method)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 11 "/home/er/myagv_ros/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg"
      const int ObstaclePlugin_Overwrite = 0;
//#line 12 "/home/er/myagv_ros/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg"
      const int ObstaclePlugin_Maximum = 1;
//#line 13 "/home/er/myagv_ros/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg"

...
"""autogenerated by genpy from rtabmap_msgs/NodeData.msg. Do not edit."""
import codecs
import sys
...
class NodeData(genpy.Message):
  _md5sum = "bbf7b81adbf2e3b56c6bae97e128cd38"
  _type = "rtabmap_msgs/NodeData"
...
int32 type
float64 value"""
  __slots__ = ['id','mapId','weight','stamp','label','pose','groundTruthPose','gps','image','depth','fx','fy','cx','cy','width','height','baseline','localTransform','laserScan','laserScanMaxPts','laserScanMaxRange','laserScanFormat','laserScanLocalTransform','userData','grid_ground','grid_obstacles','grid_empty_cells','grid_cell_size','grid_view_point','wordIdKeys','wordIdValues','wordKpts','wordPts','wordDescriptors','globalDescriptors','env_sensors']
  _slot_types = ['int32','int32','int32','float64','string','geometry_msgs/Pose','geometry_msgs/Pose','rtabmap_msgs/GPS','uint8[]','uint8[]','float32[]','float32[]','float32[]','float32[]','float32[]','float32[]','float32[]','geometry_msgs/Transform[]','uint8[]','int32','float32','int32','geometry_msgs/Transform','uint8[]','uint8[]','uint8[]','uint8[]','float32','rtabmap_msgs/Point3f','int32[]','int32[]','rtabmap_msgs/KeyPoint[]','rtabmap_msgs/Point3f[]','uint8[]','rtabmap_msgs/GlobalDescriptor[]','rtabmap_msgs/EnvSensor[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.wordIdKeys is None:
        self.wordIdKeys = []
      if self.wordIdValues is None:
        self.wordIdValues = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.baseline)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.baseline))
      ...
      length = len(self.wordIdKeys)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.wordIdKeys))
      length = len(self.wordIdValues)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.wordIdValues))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.baseline = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.localTransform = []
      ...
      self.wordIdKeys = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.wordIdValues = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.wordKpts = []
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.baseline.tostring())
      length = len(self.localTransform)
      buff.write(_struct_I.pack(length))
      for val1 in self.localTransform:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.wordIdKeys.tostring())
      length = len(self.wordIdValues)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.wordIdValues.tostring())
      length = len(self.wordKpts)
      buff.write(_struct_I.pack(length))
      for val1 in self.wordKpts:
        _v17 = val1.pt
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.baseline = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.localTransform = []
      ...
      self.wordIdKeys = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.wordIdValues = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.wordKpts = []

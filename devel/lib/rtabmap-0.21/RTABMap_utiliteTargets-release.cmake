...
set_target_properties(rtabmap::utilite PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/librtabmap_utilite.so.0.21.2"
  IMPORTED_SONAME_RELEASE "librtabmap_utilite.so.0.21"
  )

list(APPEND _IMPORT_CHECK_TARGETS rtabmap::utilite )
list(APPEND _IMPORT_CHECK_FILES_FOR_rtabmap::utilite "${_IMPORT_PREFIX}/lib/librtabmap_utilite.so.0.21.2" )
